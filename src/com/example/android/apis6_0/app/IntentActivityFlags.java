...
public class IntentActivityFlags extends Activity {
    ...
    private Intent[] buildIntentsToViewsLists() {
        ...
        intent.setClass(IntentActivityFlags.this, com.example.android.apis6_0.ApiDemos.class);
        intent.putExtra("com.example.android.apis6_0.Path", "Views");
        intents[1] = intent;

        intent = new Intent(Intent.ACTION_MAIN);
        intent.setClass(IntentActivityFlags.this, com.example.android.apis6_0.ApiDemos.class);
        intent.putExtra("com.example.android.apis6_0.Path", "Views/Lists");
