...
package com.example.android.apis6_0.app;
...
public class IncomingMessage extends Activity {
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(context,
                com.example.android.apis6_0.ApiDemos.class));

        // "App"
        intents[1] = new Intent(context, com.example.android.apis6_0.ApiDemos.class);
        intents[1].putExtra("com.example.android.apis6_0.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, com.example.android.apis6_0.ApiDemos.class);
        intents[2].putExtra("com.example.android.apis6_0.Path", "App/Notification");
