...
<table class="LinkTable">
        <tr>
            <td class="LinkColumn">src/com.example.android.apis6_0/app/ReceiveResult.java</td>
            <td class="DescrColumn">Launches pick activity and receives its result</td>
        </tr>
        <tr>
            <td class="LinkColumn">src/com.example.android.apis6_0/app/SendResult.java</td>
